...
if os.environ.get("MIST_OP_PROFILING", "0") == "1":
    ...
    choices = [
        # ("uniform-pp", False, False, (False, False), 1),
        ...
        ("uniform-device-pp-mip", True, True, (False, False), 30),
        # # =====================================================================
        # ("uniform-device-pp-mip", True, True, (True, False), 1),
        # ("uniform-device-pp-mip", True, True, (False, True), 1),
        # ("uniform-device-pp-mip", True, True, (True, True), 1),
        # # =====================================================================
        ("uniform-device-pp-mip", False, True, (True, False), 30),
